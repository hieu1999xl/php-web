...
class Post extends BaseModel implements Feedable
{
    ...
    protected static $logAttributes = ['name', 'intro', 'content', 'type', 'is_featured', 'meta_title', 'meta_keywords', 'meta_description', 'published_at', 'moderated_at', 'moderated_by', 'status', 'created_by_alias'];
