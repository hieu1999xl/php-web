...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->modelForm($$module_name_singular, 'PATCH', route("backend.$module_name.update", $$module_name_singular))->attributes(['enctype' => 'multipart/form-data'])->class('form')->open() }}
