...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col">
                    {{ html()->modelForm($$module_name_singular, 'PATCH', route("backend.$module_name.update", $$module_name_singular), "multipart/form-data", ['files'=>true])->class('form')->attributes(["enctype" => "multipart/form-data"])->open() }}
                    @php
                        // dd($$module_name_singular);
                    @endphp
                   {{-- <form action="{{route("backend.$module_name.update", $$module_name_singular)}}" method="POST" enctype="multipart/form-data"> --}}
                        {{-- @method('PUT') --}}
                        @csrf
