...
class InsertDemoContents extends Command
{
     ...
     * @var string
     */
    protected $description = 'Insert demo data for posts, tags, and comments. --fresh option will truncate the tables.';
    ...
    public function handle()
    {
        ...
        if ($fresh) {
            if ($this->confirm('Database tables (posts, tags, comments) will become empty. Confirm truncate tables?')) {
