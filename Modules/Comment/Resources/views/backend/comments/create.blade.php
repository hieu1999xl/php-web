        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                    <a href="{{ route("backend.$module_name.index") }}" class="btn btn-secondary btn-sm ml-1" data-toggle="tooltip" title="{{ __("comment::comments.$module_title") }} {{__('comment::comments.list')}}"><i class="fas fa-list-ul"></i> @lang('comment::comments.list')</a>
                </div>
            </div>
            <!--/.col-->
        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            {{ html()->button($text = "<i class='fas fa-plus-circle'></i> " . ucfirst(__("comment::comments.$module_action")) . "", $type = 'submit')->class('btn btn-success') }}
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="float-right">
                            <div class="form-group">
                                <button type="button" class="btn btn-warning" onclick="history.back(-1)"><i class="fas fa-reply"></i> @lang('comment::comments.cancel')</button>
                            </div>
                        </div>
                    </div>
                </div>
