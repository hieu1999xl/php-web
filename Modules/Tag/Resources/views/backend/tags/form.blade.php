<div class="row">
    <div class="col-12 col-sm-4">
        <div class="form-group">
            <?php
            $field_name = 'name';
            $field_lable = label_case(__('tag::tags.name'));
    ...
    <div class="col-12 col-sm-4">
        <div class="form-group">
            <?php
            $field_name = 'slug';
            $field_lable = label_case(__('tag::tags.slug'));
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
    ...
    <div class="col-12 col-sm-4">
        <div class="form-group">
            ...
            $field_lable = label_case(__('tag::tags.group_name'));
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
...
<div class="row">
    <div class="col-8">
        <div class="form-group">
            <?php
            $field_name = 'image';
            $field_lable = label_case(__("tag::tags.$field_name"));
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
...
<div class="row">
    <div class="col-12 col-sm-4">
        <div class="form-group">
            ...
            $field_name = 'status';
            $field_lable = label_case(__("tag::tags.$field_name"));
            $field_placeholder = "--".__('tag::tags.option') ."--";
            $required = "required";
            $select_options = [
                '1'=>'Published',
                '0'=>'Unpublished',
