        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                    <a href="{{ route("backend.$module_name.index") }}" class="btn btn-secondary btn-sm ml-1" data-toggle="tooltip" title="{{ $module_title }} {{ __('tag::tags.list') }}"><i class="fas fa-list-ul"></i> @lang('tag::tags.list')</a>
                </div>
            </div>
            <!--/.col-->
        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            {{ html()->button($text = "<i class='fas fa-plus-circle'></i> " . ucfirst(__("tag::tags.$module_action")) . "", $type = 'submit')->class('btn btn-success') }}
                        </div>
                    </div>
                    <div class="col-6">
