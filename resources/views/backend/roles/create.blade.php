                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                <div class="form-group">
                                    <a href="{{ route("backend.$module_name.index") }}" class="btn btn-warning" data-toggle="tooltip" title="{{__('labels.backend.cancel')}}"><i class="fas fa-reply"></i> {{__('labels.backend.cancel')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
