        ...
        <div class="row">
            <div class="col">
                <h4 class="card-title mb-0">
                    <i class="{{ __("$module_icon") }}"></i> {{ __($module_title) }}
                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="{{$row_class}}">
                            ...
                            <td class="text-right">
                                <a href='{!!route("backend.$module_name.show", $module_name_singular)!!}' class='btn btn-sm btn-success mt-1' data-toggle="tooltip" title="@lang('Show') {{ ucwords(Str::singular(__($module_name))) }}"><i class="fas fa-tv"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="row">
            <div class="col-7">
                <div class="float-left">
                    @lang('Total') {{ count($$module_name) }} {{ ucwords(__("$module_name")) }}
                </div>
            </div>
            <div class="col-5">
                <div class="float-right">
