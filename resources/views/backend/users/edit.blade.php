                ...
                {{ html()->modelForm($user, 'PATCH', route('backend.users.update', $user->id))->class('form-horizontal')->open() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-7 col-sm-10">
                            <a href="{{ route('backend.users.changePassword', $user->id) }}" class="btn btn-outline-primary btn-sm"><i class="fas fa-key"></i> @lang('Change Password')</a>
                        </div>
                    </div><!--form-group-->

                    <div class="form-group row">
                        {{ html()->label(__('Profile'))->class('col-5 col-sm-2 form-control-label')->for('profile') }}

                        <div class="col-7 col-sm-10">
                            <a href="{{ route("backend.users.profileEdit", $user->id) }}" class="btn btn-outline-primary btn-sm"><i class="fas fa-user"></i>@lang('Update Profile')</a>
                        </div>
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-7 col-sm-10">
                            ...
                            <a href="{{route('backend.users.emailConfirmationResend', $user->id)}}" class="btn btn-outline-primary btn-sm " data-toggle="tooltip" title="Send Confirmation Email"><i class="fas fa-envelope"></i> @lang("Send Confirmation Email")</a>
                            @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="float-right">
                                ...
                                <a href="{{route('backend.users.unblock', $$module_name_singular)}}" class="btn btn-info" data-method="PATCH" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.unblock')}}" data-confirm="Are you sure?"><i class="fas fa-check"></i> {{__('labels.backend.unblock')}}</a>
                                @endif
                                ...
                                <a href="{{route("backend.$module_name.destroy", $$module_name_singular)}}" class="btn btn-danger" data-confirm="Are you sure to delete this item???" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.delete')}}"><i class="fas fa-trash-alt"></i> {{__('labels.backend.delete')}}</a>
                                @endif
                                <a href="{{ route("backend.$module_name.index") }}" class="btn btn-warning" onclick="return confirm('Are you sure back without Save ???')" data-toggle="tooltip" title="{{__('labels.backend.cancel')}}"><i class="fas fa-reply"></i> {{__('labels.backend.cancel')}}</a>
                            </div>
                        </div>
                    </div>
                {{ html()->closeModelForm() }}
