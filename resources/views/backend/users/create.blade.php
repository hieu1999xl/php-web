        ...
        <div class="row mt-4">
            <div class="col">
                ...
                {{ html()->form('POST', route('backend.users.store'))->class('form-horizontal')->open() }}
                    ...
                    ?>
                        <div class="col-md-3">
                        {{ html()->label(__('labels.backend.users.fields.first_name'))->for('first_name') }}{!! fielf_required($required) !!}
                        </div>
                        <div class="col-sm-10">
                    ...
                    ?>
                    <div class="col-md-3">
                    {{ html()->label(__('labels.backend.users.fields.last_name'))->for('last_name') }} {!! fielf_required($required) !!}
                    </div>
                        <div class="col-sm-10">
                            {{ html()->text('last_name')
                                ->class('form-control')
                    ...
                    ?>
                    <div class="col-md-3">
                    {{ html()->label(__('labels.backend.users.fields.email'))->for('email') }}{!! fielf_required($required) !!}
                    </div>
                        <div class="col-sm-10">
                            {{ html()->email('email')
                                ->class('form-control')
                    ...
                    ?>
                    <div class="col-md-3">
                    {{ html()->label(__('labels.backend.users.fields.password'))->for('password') }}{!! fielf_required($required) !!}
                    </div>
                        <div class="col-sm-10">
                    ...
                    ?>
                    <div class="col-md-3">
                        {{ html()->label(__('labels.backend.users.fields.password_confirmation'))->for('password_confirmation') }} {!! fielf_required($required) !!}
                    </div>
                        <div class="col-sm-10">
