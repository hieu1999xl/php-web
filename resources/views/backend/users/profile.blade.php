...
<x-backend-breadcrumbs>
    ...
    <x-backend-breadcrumb-item type="active">{{__('labels.text.profile')}}</x-backend-breadcrumb-item>
</x-backend-breadcrumbs>
@endsection
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('backend.users.changeProfilePassword', $user->id) }}" class="btn btn-outline-primary btn-sm">@lang('Change Password')</a>
                            </td>
                        </tr>
