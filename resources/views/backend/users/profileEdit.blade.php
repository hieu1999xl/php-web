        ...
        <div class="row">
            <div class="col-8">
                <h4 class="card-title mb-0">
                    <i class="{{$module_icon}}"></i> {{__('labels.text.profile')}}
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            $field_lable = label_case(__("labels.text.$field_name"));
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group">
                            ...
                            $field_lable = label_case(__("labels.backend.users.fields.$field_name"));
                            $field_placeholder = $field_lable;
                            $required = "";
                            ?>
                            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
