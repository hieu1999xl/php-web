        ...
        <div class="row">
            <div class="col-8">
                ...
                <div class="small text-muted">
                    ...
                    {{__(":module_name ". __('management_dashboard'), ['module_name'=>Str::title(__($module_name))])}}
                </div>
            </div>
            <!--/.col-->
            <div class="col-4">
                <div class="float-right">
                    <a href="{{ route("backend.$module_name.create") }}" class="btn btn-success m-1 btn-sm" data-toggle="tooltip" title="{{__("Create new")}}"><i class="fas fa-plus-circle"></i> @lang(__('Create new') ." :module_name", ['module_name'=>Str::title(__($module_name))])</a>
                </div>
            </div>
            <!--/.col-->
        </div>
