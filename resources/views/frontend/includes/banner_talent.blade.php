...
<section class="section_banner_top">
    <picture>
        <source srcset="{{asset('frontend/assets/images/banners/bgtalent.webp')}}" media="(min-width: 480px)">
        <img class="bg_img" src="{{asset('frontend/assets/images/banners/bgtalentmb.webp')}}" alt="health care">
    </picture>
